...
def test_variable_recurrence_is_evidence_without_invented_amount():
    ...
    assert len(groups) == 1
    assert groups[0].amount_policy == "unresolved_variable_amount"
...
def test_classification_requires_flexible_recurring_evidence_for_modification():
    ...
    recurrence = main.RecurrenceEvidence([flexible], 7, ("dining",), "unresolved_variable_amount", None, ("y",), "unresolved")
